"""
Django settings for BUYproject project.
...
SECRET_KEY = 'django-insecure-7^)rc=_(48b5tfi0$%j1r)jktb3rc4kz_c9=@qgm(le4jt3d%s'
...
WSGI_APPLICATION = 'BUYproject.wsgi.application'
